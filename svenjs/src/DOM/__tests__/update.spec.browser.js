...
describe('Update (non-jsx)', () => {
	...
	it('should render a node with dynamic values', () => {
		...
		render(template('Svenjs', 'Owns'), container);
		expect(
			container.innerHTML
		).to.equal(
			innerHTML('<div>Hello world - Svenjs Owns</div>')
		);
		render(template('Svenjs', 'Owns'), container);
		expect(
			container.innerHTML
		...
		render(template('Svenjs', null), container);
		expect(
			container.innerHTML
		).to.equal(
			innerHTML('<div>Hello world - Svenjs </div>')
		);
